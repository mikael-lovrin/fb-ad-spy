...
from storage.database import init_db, get_latest_snapshots, get_keyword_trend, get_stats, get_conn
...
# Tabs
# ---------------------------------------------------------------------------
tab_leader, tab_niche, tab_trend, tab_swipe = st.tabs([
    "🏆 Leaderboard", "🔍 By Niche", "📈 Trends", "💼 Swipe File"
])
